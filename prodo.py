...
class Pad:
    ...
    def __new__(cls, title, id):  # Figure out how to check and keep track of id's for uniqueness
        if len(title) < 40:
            return super(Pad, cls).__new__(cls)
        else:
            raise ValueError("Please enter title with less than 40 characters.")
